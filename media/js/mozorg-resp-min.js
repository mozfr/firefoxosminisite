/*! jQuery v1.11.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ ! function(d, c) {
...
! function(d, c) {
  ...
  function B(G, F, E, o) {
    var n = ["opacity", F, ~~ (100 * G), E, o].join("-"),
      m = 0.01 + E / o * 100,
      l = Math.max(1 - (1 - G) / F * (100 - m), G),
      k = u.substring(0, u.indexOf("Animation")).toLowerCase(),
      j = k && "-" + k + "-" || "";
  ...
  function v() {
    ...
    r.addRule(".spin-vml", "behavior:url(#default#VML)"), w.prototype.lines = function(G, F) {
      ...
      var n, g = F.length + F.width,
        e = 2 * g,
        c = 2 * -(F.width + F.length) + "px",
        b = z(E(), {
          position: "absolute",
          top: c,
          left: c
  ...
  w.defaults = {}, y(w.prototype, {
    spin: function(M) {
      ...
      if (z(J, {
        ...
        var I, H = 0,
          G = (K.lines - 1) * (1 - K.direction) / 2,
          F = K.fps,
          E = F / K.speed,
          j = (1 - K.opacity) / (E * K.trail / 100),
          e = E / K.lines;
        ! function a() {
          H++;
...
(function() {
  ...
  a.linkMenuHideOnClick = function() {
    if (a.mainMenuItems.length === 0) {
      $("#nav-main-menu > li > a").on("click.smallmode", function(b) {
        a.closeSmallMenu()
      })
    } else {
      $(".submenu > li > a").on("click.smallmode", function(b) {
        a.closeSmallMenu()
      })
    }
  };
