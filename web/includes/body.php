    ...
    <div class="promo-grid-inner">
      <ul class="promo-grid  stagger reveal">
        ...
        <img class="primary go" src="media/img/foxprimez-vous.png" alt="Le renard s’exprime publiquement">
          ...
          <a class="panel-link" href="https://blog.mozfr.org/post/2015/05/Ce-qui-a-etonne-AmarOk-en-rejoignant-le-groupe-comm-pour-Firefox-OS-et-Mozilla" rel="external">
            <div class="secondary">
              <h3>Prenez la parole et la communauté vous répond&nbsp;!</h3>
              <p class="more">Ce qui a étonné AmarOk</p>
            </div>
          </a>
        </li>
